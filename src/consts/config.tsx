...
export const instructions = {
    "speak_english": { test: 'please speak english', explain: 'say "speak english" - for making the application repeat what you say in english' },
    ...
    "translate_from_he_to_ar": { test: 'please translate from hebrew to arabic', explain: "say 'translate from hebrew to arabic' - for making the application recognize speech in hebrew and speak out the russian translation" },
