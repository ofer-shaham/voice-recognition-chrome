...
export function parseProjectFile(text: string): YtProject {
  ...
  const tracks: YtTrack[] = rawTracks
    .map((track: any, index: number) => ({
      ...
      subtitleUrl: typeof track.subtitleUrl === 'string' ? track.subtitleUrl : undefined,
    }))
  ...
  const config: ProjectConfig = {
    ...
    colOrder,
    colSettings,
    visibleLines: typeof rawConfig.visibleLines === 'number' && Number.isFinite(rawConfig.visibleLines) && rawConfig.visibleLines >= 3 ? rawConfig.visibleLines : 30,
  };
