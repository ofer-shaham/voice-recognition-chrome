export interface YtTrack {
  ...
  isAuto: boolean;
  srtContent: string;
  /** Original subtitle URL, when the track came from a direct provider URL. */
  subtitleUrl?: string;
}
...
export interface YtProject {
  ...
  /** Invidious captions-index URL used to discover additional direct tracks. */
  subtitleIndexUrl?: string;
}
...
export interface AvailableLang {
  ...
  isDefault?: boolean;
  /** Direct subtitle URL for providers such as Invidious. */
  subtitleUrl?: string;
}
